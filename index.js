...
eval("\nvar content = __webpack_require__(/*! !../node_modules/css-loader!./estilos.css */ \"./node_modules/css-loader/index.js!./css/estilos.css\");\n\nif(typeof content === 'string') content = [[module.i, content, '']];\n\nvar transform;\nvar insertInto;\n\n\n\nvar options = {\"hmr\":true}\n\noptions.transform = transform\noptions.insertInto = undefined;\n\nvar update = __webpack_require__(/*! ../node_modules/style-loader/lib/addStyles.js */ \"./node_modules/style-loader/lib/addStyles.js\")(content, options);\n\nif(content.locals) module.exports = content.locals;\n\nif(false) {}\n\n//# sourceURL=webpack:///./css/estilos.css?");
...
eval("module.exports = __webpack_require__.p + \"css/sprites.png\";\n\n//# sourceURL=webpack:///./css/sprites.png?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _css_estilos_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/estilos.css */ \"./css/estilos.css\");\n/* harmony import */ var _css_estilos_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_css_estilos_css__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _Dinossauro__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Dinossauro */ \"./js/Dinossauro.js\");\n/* harmony import */ var _Deserto__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Deserto */ \"./js/Deserto.js\");\n/* harmony import */ var _Nuvem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Nuvem */ \"./js/Nuvem.js\");\n/* harmony import */ var _Cacto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Cacto */ \"./js/Cacto.js\");\n/* harmony import */ var _Pterossauro__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Pterossauro */ \"./js/Pterossauro.js\");\n/* harmony import */ var _Gameover__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Gameover */ \"./js/Gameover.js\");\n/* harmony import */ var _EventListener__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./EventListener */ \"./js/EventListener.js\");\n/* harmony import */ var _Placar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Placar */ \"./js/Placar.js\");\n\n\n\n\n\n\n\n\n\nvar FPS = 300;\nvar PROB_NUVEM = 1;\nvar PROB_CACTO = 1;\nvar PROB_PTEROSSAURO = 1;\nvar MAX_SAFE = 70;\nvar nuvens = [];\nglobal.cactos = [];\nglobal.pterossauros = [];\nglobal.gamestatus = 0; // 0 se ainda não iniciado; 1 iniciado 2 pausado 3 gameover\n\nvar deserto = new _Deserto__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\nvar gameover = new _Gameover__WEBPACK_IMPORTED_MODULE_6__[\"default\"](deserto);\nvar dinossauro = new _Dinossauro__WEBPACK_IMPORTED_MODULE_1__[\"default\"](deserto);\nvar placar = new _Placar__WEBPACK_IMPORTED_MODULE_8__[\"default\"](deserto);\nvar contadorframes = 0;\nvar safe = 0;\nglobal.pterossauros.push(new _Pterossauro__WEBPACK_IMPORTED_MODULE_5__[\"default\"](deserto));\nObject(_EventListener__WEBPACK_IMPORTED_MODULE_7__[\"default\"])(deserto, dinossauro, nuvens, init, gameover);\n\nfunction init() {\n  global.gamestatus = 1;\n  setInterval(run, 1000 / FPS);\n}\n\nvar doElsCollide = function doElsCollide(el1, el2) {\n  el1.offsetBottom = el1.offsetTop + el1.offsetHeight;\n  el1.offsetRight = el1.offsetLeft + el1.offsetWidth;\n  el2.offsetBottom = el2.offsetTop + el2.offsetHeight;\n  el2.offsetRight = el2.offsetLeft + el2.offsetWidth;\n  return !(el1.offsetBottom < el2.offsetTop || el1.offsetTop > el2.offsetBottom || el1.offsetRight < el2.offsetLeft || el1.offsetLeft > el2.offsetRight);\n};\n\nfunction run() {\n  if (global.gamestatus === 1) {\n    contadorframes++;\n\n    if (contadorframes % 6000 === 0) {\n      deserto.trocaTurno();\n    }\n\n    if (contadorframes % 100 === 0) {\n      placar.incrementa();\n    }\n\n    deserto.mover();\n\n    if (contadorframes % 1000 === 0) {\n      deserto.maisRapido();\n      MAX_SAFE -= 0.5;\n    }\n\n    dinossauro.correr();\n\n    if (Math.floor(Math.random() * 3000) <= PROB_NUVEM) {\n      nuvens.push(new _Nuvem__WEBPACK_IMPORTED_MODULE_3__[\"default\"](deserto));\n    }\n\n    if (Math.floor(Math.random() * 3000) <= PROB_CACTO && safe > MAX_SAFE) {\n      global.cactos.push(new _Cacto__WEBPACK_IMPORTED_MODULE_4__[\"default\"](deserto));\n      safe = 0;\n    } else if (Math.floor(Math.random() * 3000) <= PROB_PTEROSSAURO && safe > MAX_SAFE) {\n      global.pterossauros.push(new _Pterossauro__WEBPACK_IMPORTED_MODULE_5__[\"default\"](deserto));\n      safe = 0;\n    }\n\n    safe++;\n    nuvens.forEach(function (n) {\n      n.mover();\n\n      if (contadorframes % 1000 === 0) {\n        n.maisRapido();\n      }\n    });\n    global.cactos.forEach(function (c) {\n      if (doElsCollide(c.element, dinossauro.element)) {\n        gameover.showendgame();\n        global.gamestatus = 3;\n      }\n\n      if (contadorframes % 1000 === 0) {\n        c.maisRapido();\n      }\n\n      c.mover();\n    });\n    global.pterossauros.forEach(function (p) {\n      if (doElsCollide(p.element, dinossauro.element)) {\n        gameover.showendgame();\n        global.gamestatus = 3;\n      }\n\n      if (contadorframes % 1000 === 0) {\n        p.maisRapido();\n      }\n\n      p.mover();\n    });\n  }\n}\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./js/trex.js?");
...
/***/ 0:
/*!******************************************!*\
  !*** multi @babel/polyfill ./js/trex.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./js/trex.js */\"./js/trex.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./js/trex.js?");
